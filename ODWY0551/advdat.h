...
typedef enum {
    ...
    R_BOOTH, R_DEVILS, R_DEAD191, R_GRAVEL, R_FLOWER,
...
typedef enum {
    ...
    BOAT, STICKS, STICKS_, GOLD, DIAMONDS, HORN, JEWELS, COINS, CHEST,
    EGGS, TRIDENT, VASE, EMERALD, PYRAMID, PEARL, RUG, RUG_, SPICES,
    CHAIN, SWORD, CROWN, SHOES, LYRE, SAPPHIRE, GRAIL, CASK, RING,
    CLOVER, TREE, DROPLET, WATER, WATER_IN_CASK, OIL, OIL_IN_CASK,
    WINE, WINE_IN_CASK, BEES, ECHO, SAFE_WALL, TINY_KEY,
    ANVIL, CLOAKROOM_ROCKS, BOOTH, BOOTH_, PHONE, SLUGS, HONEY,
    HIVE, DOG, WUMPUS, BIRD, KEYS, FOUNTAIN, BATS, GNOME, MUSHROOMS,
    CAKES, SACK, BOOK, REPO_BOOK, SAFE, POSTER, BROOM, CARVING,
    BILLBOARD, CANISTER, RADIUM, BALL, ALL,
    MAX_OBJ=ALL
} ObjectWord;
