...
{
    assert(&travels[0] <= q && q < &travels[sizeof travels/sizeof travels[0]]);
...
struct Dwarf {
    ...
    { false, R_LIMBO, R_HMK },
    { false, R_LIMBO, R_ROTUNDA },
    { false, R_LIMBO, R_Y2 },
    { false, R_LIMBO, R_MAZEA44 },
    { false, R_LIMBO, R_SHELL },
};
...
void pirate_tracks_you(Location loc)
{
    ...
    if (pirate->oldloc != pirate->loc && pct(30)) {
