...
C  Dummy varible ORC in sub ORCALL also in COMMON! Dummy removed JP Nov01
C  Thirst comments increased JP Nov 01
C  SAY command WRITE instruction given back its FORMAT statement as it
C  was printing ASCII numbers not the letters using * O/P. JP Nov 01
C  BLOW when dark is now allowed, with HORN/OWL implications. JP Nov 01
C
